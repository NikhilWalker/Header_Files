...
#include <string> //for exception message
#include <stdexcept>        //for exception
#include <initializer_list> //for intializer list
#include "iterator_linked_list.h" //iterator for linked list
...
public:
	...
	// constructors
	linked_list() = default;
	linked_list(const T& init, int size=1);
	linked_list(T&& d);
